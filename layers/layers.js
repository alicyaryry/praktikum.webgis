...
lyr_GoogleSatelliteHybrid_0.setVisible(true);lyr_AksesibilitasPTN_1.setVisible(true);lyr_PTNSurabaya_2.setVisible(true);
var layersList = [lyr_GoogleSatelliteHybrid_0,lyr_AksesibilitasPTN_1,lyr_PTNSurabaya_2];
